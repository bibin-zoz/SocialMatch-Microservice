...
func (c *connectionsClient) CheckUserConnection(ctx context.Context, in *CheckUserConnectionReq, opts ...grpc.CallOption) (*ConnectionResponse, error) {
	out := new(ConnectionResponse)
	err := c.cc.Invoke(ctx, Connections_CheckUserConnection_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedConnectionsServer) CheckUserConnection(context.Context, *CheckUserConnectionReq) (*ConnectionResponse, error) {
...
func _Connections_CheckUserConnection_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CheckUserConnectionReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ConnectionsServer).CheckUserConnection(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Connections_CheckUserConnection_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ConnectionsServer).CheckUserConnection(ctx, req.(*CheckUserConnectionReq))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Connections_CheckUserConnection_Handler,
		},
	},
