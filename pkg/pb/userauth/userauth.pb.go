...
var file_pkg_pb_userauth_userauth_proto_rawDesc = []byte{
	...
	0x12, 0x04, 0x75, 0x73, 0x65, 0x72, 0x22, 0xdf, 0x01, 0x0a, 0x11, 0x55, 0x73, 0x65, 0x72, 0x53,
	...
	0x70, 0x68, 0x6f, 0x6e, 0x65, 0x22, 0x66, 0x0a, 0x17, 0x55, 0x73, 0x65, 0x72, 0x45, 0x64, 0x69,
	...
	0x52, 0x0b, 0x75, 0x73, 0x65, 0x72, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x22, 0xa7, 0x01,
	...
	0x68, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x32, 0xdb, 0x01, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12,
	...
	0x73, 0x65, 0x22, 0x00, 0x42, 0x13, 0x5a, 0x11, 0x2e, 0x2f, 0x70, 0x6b, 0x67, 0x2f, 0x70, 0x62,
	0x2f, 0x75, 0x73, 0x65, 0x72, 0x61, 0x75, 0x74, 0x68, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
...
var file_pkg_pb_userauth_userauth_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_pkg_pb_userauth_userauth_proto_goTypes = []interface{}{
	(*UserSignUpRequest)(nil),       // 0: user.UserSignUpRequest
	(*UserEditDetailsRequest)(nil),  // 1: user.UserEditDetailsRequest
	(*UserDetails)(nil),             // 2: user.UserDetails
	(*UserEditDetailsResponse)(nil), // 3: user.UserEditDetailsResponse
...
var file_pkg_pb_userauth_userauth_proto_depIdxs = []int32{
	2, // 0: user.UserEditDetailsResponse.userDetails:type_name -> user.UserDetails
	2, // 1: user.UserSignUpResponse.userDetails:type_name -> user.UserDetails
	2, // 2: user.UserLoginResponse.userDetails:type_name -> user.UserDetails
	0, // 3: user.User.UserSignUp:input_type -> user.UserSignUpRequest
	5, // 4: user.User.UserLogin:input_type -> user.UserLoginRequest
	1, // 5: user.User.UserEditDetails:input_type -> user.UserEditDetailsRequest
	4, // 6: user.User.UserSignUp:output_type -> user.UserSignUpResponse
	6, // 7: user.User.UserLogin:output_type -> user.UserLoginResponse
	3, // 8: user.User.UserEditDetails:output_type -> user.UserEditDetailsResponse
